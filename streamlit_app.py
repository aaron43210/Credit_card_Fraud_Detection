"""
Professional Streamlit app for Credit Card Fraud Detection.
...
# ================================================================
# PATH CONFIGURATION (STREAMLIT CLOUD COMPATIBLE)
# ================================================================

def get_project_root() -> Path:
    """Get project root - works both locally and on Streamlit Cloud."""
    # Check if we're in a subdirectory (PROJECT/)
    current = Path(__file__).resolve().parent
    
    # If PROJECT/app.py or PROJECT/src exists, use PROJECT dir
    if (current / 'PROJECT' / 'src').exists():
        return current / 'PROJECT'
    
    # If src exists in current dir, we're already at PROJECT root
...
ROOT_DIR = PROJECT_ROOT.parent if PROJECT_ROOT.name == 'PROJECT' else PROJECT_ROOT
...
try:
    ...
    # Fallback path definitions for Streamlit Cloud
    DT_MODEL_PATH = ROOT_DIR / 'models' / 'decision_tree.pkl'
    XGB_MODEL_PATH = ROOT_DIR / 'models' / 'xgboost_model.pkl'
    HGNN_MODEL_PATH = ROOT_DIR / 'models' / 'hgnn_model.pt'
    SCALER_PATH = ROOT_DIR / 'models' / 'scaler.pkl'
    FEATURE_NAMES_PATH = ROOT_DIR / 'models' / 'feature_names.pkl'
    LABEL_ENCODERS_PATH = ROOT_DIR / 'models' / 'label_encoders.pkl'
